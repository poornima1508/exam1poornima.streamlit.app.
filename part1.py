...
numeric_cols = ['bore', 'stroke', 'compression-ratio', 'horsepower', 'price', 'peak-rpm', 'normalized-losses']
...
st.write("""
The regression line suggests a **weak or no linear relationship**, consistent with the low correlation coefficient.
""")
